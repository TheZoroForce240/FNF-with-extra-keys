...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	var keyAmmo:Array<Int> = [4, 6, 9, 5, 7, 8];
	...
	function addSongUI():Void
	{
		...
		var m_check3 = new FlxUICheckBox(90, 45, null, null, "5", 100);
		...
		var m_check4 = new FlxUICheckBox(140, 45, null, null, "7", 100);
		...
		var m_check5 = new FlxUICheckBox(90, 65, null, null, "8", 100);
		...
		tab_group_song.add(m_check4);
		tab_group_song.add(m_check5);
